...
class AddStockFieldsToItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('items', function (Blueprint $table) {
            $table->unsignedBigInteger('stock_item_id')->nullable()->after('detail_entry_id');
            $table->unsignedBigInteger('stock_lot_id')->nullable()->after('stock_item_id');
            $table->unsignedBigInteger('warehouse_id')->nullable()->after('typescrap_id');
            $table->decimal('unit_cost', 14, 4)->default(0)->after('price');
