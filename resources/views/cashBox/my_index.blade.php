...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><i class="fa fa-list"></i> Mis movimientos</li>
    </ol>
@endsection
    ...
    <div class="d-flex flex-wrap flex-stack pb-2 mt-3">
        <div class="d-flex flex-wrap align-items-center my-1">
            <h3 class="fw-bolder me-5 my-1">
                <span id="numberItems"></span> movimientos encontrados
            </h3>
        </div>
    </div>
...
@section('scripts')
    <script>
        window.CASH_MOVEMENT_LIST_URL = "{{ route('cashMovement.my.list') }}";
    ...
    <script src="{{ asset('js/cashBox/my_index.js') }}"></script>
@endsection
